...
<div class="row mt-3">
    {% include figure.html path="assets/img/posts/the-vault/the-vault-1.png" class="img-fluid rounded z-depth-1" %}
</div>
<div class="caption">
...
<div class="row mt-3">
    {% include figure.html path="assets/img/posts/the-vault/the-vault-2.png" class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row mt-3">
    {% include figure.html path="assets/img/posts/the-vault/the-vault-3.png" class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row mt-3">
    {% include figure.html path="assets/img/posts/the-vault/the-vault-4.png" class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row mt-3">
    {% include figure.html path="assets/img/posts/the-vault/the-vault-5.png" class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row mt-3">
    {% include figure.html path="assets/img/posts/the-vault/the-vault-6.png" class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row mt-3">
    {% include figure.html path="assets/img/posts/the-vault/the-vault-7.png" class="img-fluid rounded z-depth-1" %}
</div>
<div class="caption">
...
<div class="row mt-3">
    {% include figure.html path="assets/img/posts/the-vault/the-vault-8.png" class="img-fluid rounded z-depth-1" %}
</div>
<div class="caption">
...
<div class="row mt-3">
    {% include figure.html path="assets/img/posts/the-vault/the-vault-9.png" class="img-fluid rounded z-depth-1" %}
</div>

## Data characteristics distributions

<div class="row mt-3">
    {% include figure.html path="assets/img/posts/the-vault/the-vault-10.png" class="img-fluid rounded z-depth-1" %}
</div>
